...
public class CommentAppendService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		int pageCnt = (int)Math.ceil((double)totalComment/PAGESIZE);//페이지갯수
		System.out.println(pageCnt +"페이지 중 현재 "+recurrentPage);
		if(recurrentPage<=pageCnt) {
			...
			request.setAttribute("repageNum", recurrentPage);// pageNum 없으면 param.pageNum
		}else {
