	...
	public ArrayList<FileboardDto> listBoard(int startRow, int endRow) {
		...
		try {
			...
			while (rs.next()) {
				...
				dtos.add(new FileboardDto(fnum, mid, mname, fsubject, fcontent, ffilename, ffilename2, ffilename3,
...
//	
	...
	public int writeBoard(String mid, String fsubject, String fcontent, String ffilename, String ffilename2,
			String ffilename3, String fip) {
		int result = FAIL;
		Connection conn = null;
		PreparedStatement pstmt = null;
...
//	
	...
	private void preReplyStepA(int fgroup, int fstep) {
		...
		try { //
			...
			System.out.println(result == 0 ? "성공" : result + "실패");
		} catch (SQLException e) {
			System.out.println(e.getMessage());
		} finally {
...
//	
	public int replyBoard(String mid, String fsubject, String fcontent, String ffilename, String ffilename2,
			String ffilename3, int fgroup, int fstep, int findent, String fip) {
	...
	//
	public int modifyBoard(int fnum, String fsubject, String fcontent, String ffilename, String ffilename2,
			String ffilename3, String fip) {
		int result = FAIL;
		Connection conn = null;
		PreparedStatement pstmt = null;
		String sql = "UPDATE FILEBOARD SET fSUBJECT=?," + "              FCONTENT=?," + "                FFILENAME =?,"
				+ "                fFILENAME2 = ?," + "                fFILENAME3 = ?,"
				+ "                fRDATE = SYSDATE, " + "                fIP = ? " + "               WHERE fNUM= ?  ";
	...
	public FileboardDto getBoard(int fnum) {
		...
		try {
			...
			if (rs.next()) {
				...
				int findent = rs.getInt("findent");
				String fip = rs.getString("fip");
				dto = new FileboardDto(fnum, mid, mname, fsubject, fcontent, ffilename, ffilename2, ffilename3, frdate,
...
//
	public void withdrawDeleteBoard(int mid) {
		...
		try {
			...
			pstmt.setInt(1, mid);
			pstmt.executeUpdate();
			System.out.println("강제 삭제 성공");
		} catch (SQLException e) {
			System.out.println(e.getMessage() + "강제 삭제 실패");
		} finally {
...
//       WHERE RN BETWEEN  1 AND 10
	...
	public FileboardDto prevBoard(int fnum) {
		FileboardDto dto = null;
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
