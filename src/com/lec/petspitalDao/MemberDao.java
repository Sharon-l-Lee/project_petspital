...
public class MemberDao {
	...
	// 회원 로그인 SELECT * FROM MEMBER WHERE mID ='aaa' AND mPW ='111';
	...
	// 아이디 중복 체크 SELECT * FROM MEMBER WHERE mID='aaa';
	...
	// 이메일 중복 체크 SELECT * FROM MEMBER WHERE mEMAIL ='aaa@naver.com';
...
//		//ID로 DTO 가져오기 SELECT * FROM MEMBER WHERE mID ='aaa';
	...
	// mADDRESS, mADDRESS2)
	// VALUES ('aaa', '111', '이토끼', '95/01/01', 'M','bunny@naver.com',
	// '010-0000-1111', '서울시 강남구', '어쩌구로') ;
	...
	public int joinMember(MemberDto member) {
		...
		try {
			...
			System.out.println(result == SUCCESS ? "회원가입성공" : "실패");
		} catch (SQLException e) {
			System.out.println(e.getMessage());
		} finally {
...
//      	  WHERE mID='aaa';
	...
	public int modifyMember(MemberDto member) {
		...
		try {
			...
			result = pstmt.executeUpdate();
			System.out.println(result == SUCCESS ? "회원수정" : "실패");
		} catch (SQLException e) {
			System.out.println(e.getMessage());
		} finally {
	...
	public ArrayList<MemberDto> listMember(int startRow, int endRow) {
		...
		try {
			...
			System.out.println(e.getMessage() + "allView list");
		} finally {
...
//		회원수 SELECT COUNT(*) CNT FROM MEMBER;
	...
	//회원 탈퇴 DELETE FROM MEMBER WHERE MID = 'NNN';
	...
	public int deleteMember(String mid) {
		...
		try {
			...
			pstmt.setString(1, mid);
			result = pstmt.executeUpdate();
			System.out.println(result == SUCCESS ? "회원삭제" : "실패");
		} catch (SQLException e) {
			System.out.println(e.getMessage());
		} finally {
	...
	//회원 등급 변경 UPDATE MEMBER SET mGRADE='2' WHERE mID='aaa';
