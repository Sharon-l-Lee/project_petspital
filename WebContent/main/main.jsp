...
<body>
	<jsp:include page="../main/headermain.jsp"></jsp:include>
	<div id="wrap">
		<div id="banner">
			...
			<div id="content">
				...
				<div class="content_box">
					<div class="title">
						...
						<h4 class="sub_tit">PET+HOSPITEL</h4>
						<!-- 병원 검색 연결 -->
						<span class="sub_content">24시 응급실, 소동물 및 특수동물 진료 등<br>
							맞춤 병원을 소개합니다
						</span>
					</div>
				</div>
				<div class="content_box">
					<div class="title">
						...
						<h4 class="sub_tit">= PETSPITAL</h4>
						<!-- QNA연결 -->
						<span class="sub_content">진료비, 의료시설 등의 정보를 <br>투명하게
							공개합니다
						</span>
					</div>
				</div>
						...
						<tbody>
							<c:if test="${notice.size() !=0 }">
								<c:forEach var="i" items="${notice }">
									<tr>
										<td><a
											href="${conPath }/noticeContent.let?nnum=${i.nnum }">${i.nsubject }</a></td>
									</tr>
								</c:forEach>
								<!-- <tr><td>고양이</td></tr>
						<tr><td>쨱쨱</td></tr>
