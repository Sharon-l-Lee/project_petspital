...
<body>
	...
	<div id="wrap">
		<div id="content">
			<form action="${conPath }/hBoardModify.do?rnum=${param.rnum }" method="post"
				enctype="multipart/form-data">

				<input type="hidden" name="pageNum" value="${pageNum }">  
				<input type="hidden" name="mid" value="${member.mid } "> 
				<input type="hidden" name="dbfilename" value="${rboard.rfilename }">
				<input type="hidden" name="dbfilename2" value="${rboard.rfilename2 }">
				<input type="hidden" name="dbfilename3" value="${rboard.rfilename3 }">
				<input type="hidden" name="dbfilename3" value="${rboard.rfilename3 }">
				...
				<div id="borarcontent">
					...
					<div>
						<input type="text" name="rsubject" autofocus="autofocus"
							...
							value='${rboard.rsubject }'>
					</div>

					<div class="formtitle">첨부파일</div>
					<div>
						<input type="file" name="rfilename" class="ipt_file" value="${rboard.rfilename }"> <br>
						<input type="file" name="rfilename2" class="ipt_file" value="${rboard.rfilename2 }"> <br>
						<input type="file" name="rfilename3" class="ipt_file" value="${rboard.rfilename3 }">

					</div>
					<div class="formtitle">내용</div>
					<div class="editor">
						<textarea name="rcontent" id="rcontent"
							style="width: 80%; height: 300px; min-width: 50%;">${rboard.rcontent }</textarea>
					...
					<div class="btn_s">
						<input type="submit" value="수정하기" class="btn_style"> <input
