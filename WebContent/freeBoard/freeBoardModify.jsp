		...
		<div id="content">
			<form action="${conPath }/freeBoardModify.do?fnum=${param.fnum }" method="post"
				...
				<input type="hidden" name="pageNum" value="${pageNum }"> <input
					...
					<input type="hidden" name="dbfilename3" value="${fboard.ffilename3 }">
				...
				<div id="borarcontent">
					...
					<div>
						<input type="text" name="fsubject" autofocus="autofocus"
							...
							value="${fboard.fsubject }">
					</div>

					<div class="formtitle">첨부파일</div>
					<div>
						<input type="file" name="ffilename" class="ipt_file" value="${fboard.ffilename }"> <br>
						<input type="file" name="ffilename2" class="ipt_file" value="${fboard.ffilename2 }"> <br>
						<input type="file" name="ffilename3" class="ipt_file" value="${fboard.ffilename3 }">

					</div>
					<div class="formtitle">내용</div>
					<div class="editor">
						<textarea id="summernote" name="fcontent" required="required">${fboard.fcontent }</textarea>
					</div>

					<div class="btn_s">
						<input type="submit" value="수정하기" class="btn_style"> 
						<input type="button" value="글목록" onclick='location.href="${conPath }/freeBoardList.do?pageNum=${param.pageNum }"'
							class="btn_style">
					</div>
				</div>
			</form>
