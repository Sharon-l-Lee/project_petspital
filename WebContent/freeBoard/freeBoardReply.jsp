...
<body>
	...
	<div id="wrap">
		<div id="content">
			<form action="${conPath }/freeBoardReply.do?fnum=${param.fnum }&pageNum=${param.pageNum }" method="post"
				enctype="multipart/form-data">
				<input type="hidden" name="pageNum" value="${pageNum }"> <input
					type="hidden" name="fgroup" value="${fborigin.fgroup }"> <input
					type="hidden" name="fstep" value="${fborigin.fstep }"> <input
					type="hidden" name="findent" value="${fborigin.findent }"> <input
			...
			<caption>${not empty member ? "글쓰기" : "" }</caption> --%>
				...
				<div id="borarcontent">
					...
					<div class="btn_s">
						<input type="submit" value="답글쓰기" class="btn_style"> <input
