					...
					<div class="join_content">
						...
						<div class="group">
							...
							<div class="join_row">
								...
								<span class="pw_Chkbox"> 
								<input type="password" id="pwChk" name="pwChk" class="input"
									title="비밀번호 재확인 입력" 
									maxlength="20"> 
								</span> 
						...
						<div class="group">
							...
							<div class="join_row">
								...
								<div class="bir_wrap">
										...
										<input type="text" id="datepicker" name="mbirth" class="input" maxlength="20">
										</span>
								</div>
							</div>
							...
							<div class="join_row">
								...
								<div class="gender_box">
									<select id="mgender" name="mgender" class="select" aria-label="성별">
							...
							<div class="join_row">
								...
								<span class="email_box"> <input type="text" id="memail"
									name="memail" placeholder="선택입력" class="input"
									maxlength="100">
								</span>
							</div>
						...
						<div class="join_row " >
							...
							<div class="phone_wrap">
								...
								<input type="tel" id="mphone" name="mphone" placeholder="전화번호 입력" aria-label="전화번호 입력"
								...
								<div class="join_row">
									...
									<span class="address_box">
										...
										<input type="text" id="maddress" placeholder="주소"><br>
										<input type="text" id="maddress2" placeholder="상세주소">
									</span>
								</div>
