					...
					<div class="join_content">
						...
						<div class="group">
							<div class="join_row">
								...
								<span class="id_box"> <input type="text" id="mid"
									name="mid" class="input" value="${member.mid }"
									readonly="readonly">
								</span> <span class="msgbox" id="idMsg" style="display: none"></span>
							</div>
							...
							<div class="join_row">
								...
								<span class="pw_box"> <input type="password" id="mpw"
									name="mpw" class="input" value="${member.mpw } "
									title="비밀번호 입력" maxlength="20"> <span class="step_txt"></span>
								</span>
						...
						<div class="group">
							...
							<div class="join_row">
								...
								<span class="name_box"> <input type="text" id="mname"
									value="${member.mname }" name="mname" title="이름" class="input"
									maxlength="40">
								</span>
							</div>
							...
							<div class="join_row">
								...
								<div class="phone_wrap">
									<span class="phone_box"> <input type="tel" id="mphone"
										name="mphone" value="${member.mphone }" class="input"
										maxlength="16">
									</span>
									...
									<div class="join_row">
										...
										<span class="address_box"> <input type="text"
											id="postcode" placeholder="우편번호"> <input
											type="button" onclick="sample6_execDaumPostcode()"
											value="우편번호 찾기" class="addressBtn"><br> <input
											type="text" id="maddress" name="maddress" placeholder="주소"
											value="${member.maddress }"><br> <input
											type="text" id="maddress2" name="maddress2"
											placeholder="상세주소" value="${member.maddress2 }">
										</span>
									</div>
						...
						<div class="btn_area">
							...
							<input type="reset" value="다시하기" class="joinBtn_style"> <input
								type="button" value="뒤로가기" class="joinBtn_style"
