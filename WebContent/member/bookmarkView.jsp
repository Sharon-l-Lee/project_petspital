										...
										<tr>
											...
											<td class="boardcontent">
												<div class="boardtitle">
													<div>
															<a href="${conPath }/hBoardContent.do?rnum=${mybmark.rnum }&pageNum=${pageNum }">${mybmark.rsubject } </a>
											...
											<button onclick="location.href='${conPath}/hBookmarkOut.do?rnum=${mybmark.rnum }'">해제</button></td>
